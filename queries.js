...
class Queries {
    constructor(models) {
        ...
        this.Operators = models.sequelize.Op;
    ...
    getSouvenirsCount({ country, rating, price }) {
        ...
        return this.Souvenir.count({
            where: {
                rating: { [this.Operators.gte]: rating },
                price: { [this.Operators.lte]: price }
            },
            include: [{
                model: this.Country,
                where: { name: country }
    ...
    searchSouvenirs(substring) {
        ...
        return this.Souvenir.findAll({
            where: {
                name: { [this.Operators.iLike]: `%${substring}%` }
            }
        });
    }
